...
\begin{table}[h]
\centering\small
\caption{HalluCode middleware ablation: MARL-SL vs.\ no-middleware baseline, two models ($n{=}19$ each). $\Delta$ columns show MARL-SL minus Baseline.}
\label{tab:hallucode_ablation}
\begin{tabular}{llccccc}
\toprule
Model & Condition & CodeMEI & SR & HRR & $\Delta$CodeMEI & $\Delta$SR \\
\midrule
\multirow{2}{*}{LFM-1.2B-Thinking}
 & Baseline (no middleware) & 0.274 & 68.4\% & 0.0\% & \multirow{2}{*}{$-$0.059} & \multirow{2}{*}{$-$63.4pp} \\
 & MARL-SL (5-layer)        & 0.215 &  5.0\% & 25.0\% & & \\
\midrule
\multirow{2}{*}{GLM-4.5-Air}
 & Baseline (no middleware) & 0.579 & 78.9\% & 68.4\% & \multirow{2}{*}{$+$0.158} & \multirow{2}{*}{$+$21.1pp} \\
 & MARL-SL (5-layer)        & 0.737 & 100.0\% & 84.2\% & & \\
\bottomrule
\end{tabular}
\end{table}
