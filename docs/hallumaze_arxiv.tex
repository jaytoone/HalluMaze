...
\emph{(2) Model-size consistency}: GLM-4.5-Air (${\approx}$7B parameters) achieves SR$=$100\%; LFM-1.2B-Thinking (1.2B parameters) achieves SR$=$5\%---a 20$\times$ gap consistent with expected coding capability differences between 7B and 1.2B models. This ranking is further corroborated by Artificial Analysis Intelligence Index, which ranks LFM-1.2B-class models in the bottom decile of coding ability among 120+ evaluated models.
