...
\begin{enumerate}[nosep]
  ...
  \item Ecological validity: \textbf{[Partially completed]} HumanEval-Trap direct test (Section~\ref{sec:hallucode}, $n{=}20$ problems) confirms AP domain-agnostic transfer ($\Delta\text{pass@1}{=}{+}0.575$, $d{=}{+}1.16$). Remaining: Spearman correlation of HalluCode SR/CodeMEI with HumanEval/MBPP pass@1 across ${\geq}5$ models (companion paper); Spearman of MEI/HRR with TruthfulQA/HaluEval (companion paper).
