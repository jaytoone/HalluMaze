...
\textbf{Finding}: Multi-model validation across models shows varying success: Claude-3.7-Sonnet achieves 66.7\% SR (MEI$\approx$0.77), demonstrating cross-model viability with strong instruction-following; GPT-4o-mini and Llama-4-Scout show 0\% SR, indicating the structured layer format requires specific model capabilities.
