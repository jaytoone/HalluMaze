...
External validity is further confirmed across two public benchmarks: on HumanEval-Trap, the identical AP prompt raises pass@1 from 0.300 to 0.875 ($\Delta{=}{+}0.575$, $d{=}{+}1.16$); on MBPP-Trap, AP detection transfers (85.7\%) while task difficulty moderates pass@1 benefit.
