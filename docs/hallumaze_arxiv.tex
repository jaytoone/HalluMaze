...
MEI$=$0.829 ($+3.2$\% vs.\ Eff~v2, $+34.8$\% vs.\ baseline), SR$=$0.800, average 1.60 API calls/trial (vs.\ 6.2 for Eff~v2; $\mathbf{-74\%}$), wall-clock $=$117\,s/trial ($\mathbf{-72\%}$ vs.\ Eff~v2 $=$417\,s).
