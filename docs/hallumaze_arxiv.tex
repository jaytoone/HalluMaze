...
Adversarial Priming (AP)---a system prompt flagging potentially malicious hints---achieves CodeMEI$=$0.821 on GLM-4.5-Air ($d{=}+1.58$, $p{<}0.001$; $n{=}19$) and 0.371 on LFM-1.2B ($d{=}+0.31$, $p{=}0.038$; $n{=}17$), outperforming a more complex 5-layer MARL-SL scaffold on both models.
